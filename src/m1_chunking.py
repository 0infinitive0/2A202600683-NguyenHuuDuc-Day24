...
def chunk_hierarchical(text: str, parent_size: int = HIERARCHICAL_PARENT_SIZE,
    ...
    for para in paragraphs:
        if len(current_parent_text) + len(para) > parent_size and current_parent_text:
            ...
            parents.append(Chunk(text=current_parent_text.strip(), metadata={**metadata, "chunk_type": "parent", "parent_id": pid}, parent_id=pid))
            current_parent_text = ""
    ...
    for parent in parents:
        ...
        for para in parent_paras:
            if len(current_child_text) + len(para) > child_size and current_child_text:
                children.append(Chunk(text=current_child_text.strip(), metadata={**metadata, "chunk_type": "child"}, parent_id=parent.parent_id))
                current_child_text = ""
